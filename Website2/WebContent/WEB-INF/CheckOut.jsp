...
<title>Iron Grub | Checkout</title>
</head>
<body>
<div class="topnav">
	...
	<div class="container">
		...
		<div class="row">
				...
				<form action="CheckOut" method="post">
						...
						<div class="form-group row">
							<label class="col-sm-1 col-form-label"> <font color="black" size="3" face="Time New Roman"><b>Payment Information:</b></font></label>
							<div class="col-sm-5">
						...
						<div class="form-group row">
							<label class="col-sm-1 col-form-label"> <font color="black" size="3" face="Time New Roman"><b>Name (First name):</b></font></label> 
							<div class="col-sm-5">
